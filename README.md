...
1. Create a new repository on GitHub named `00-test-ai-api`
2. Push this directory to the repository:
   ...
   git branch -M main
   git remote add origin https://github.com/YOUR_USERNAME/00-test-ai-api.git
...
7. Click **Save**
8. Your book will be available at `https://YOUR_USERNAME.github.io/00-test-ai-api/`

## Hosting on GitLab Pages

1. Create a new project on GitLab named `00-test-ai-api`
...
3. Push this directory to the project:
   ...
   git commit -m "Initial commit"
   git branch -M main
   git remote add origin https://gitlab.com/YOUR_USERNAME/00-test-ai-api.git
   git push -u origin main
   ```
4. GitLab will automatically build and deploy your site
5. Your book will be available at `https://YOUR_USERNAME.gitlab.io/00-test-ai-api/`
